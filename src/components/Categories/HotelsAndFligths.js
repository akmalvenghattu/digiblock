                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
                        <div className="flex justify-center items-center w-full relative mt-2 rounded-md shadow-sm">
                            ...
                            <input type="text" className="w-full px-10 h-11 border border-gray-200 rounded-lg placeholder:text-gray-600 " placeholder="Flying from" />
                        ...
                        <div className="flex justify-center items-center w-full relative mt-2 rounded-md shadow-sm">
                            ...
                            <input type="text" className="w-full px-10 h-11 border border-gray-200 rounded-lg placeholder:text-gray-600 " placeholder="Flying to" />
                        </div>
                    </div>
...
export default HotelsAndFligths;